...
void DAQ_LoadGeometry::InitializeGeometry(){
...
void DAQ_LoadGeometry::LoadFACCMRDDetectors(){
...
bool DAQ_LoadGeometry::ParseMRDDataEntry(std::vector<std::string> SpecLine,
        std::vector<std::string> MRDLegendEntries){
...
void DAQ_LoadGeometry::LoadTankPMTDetectors(){
...
bool DAQ_LoadGeometry::ParseTankPMTDataEntry(std::vector<std::string> SpecLine,
        std::vector<std::string> TankPMTLegendEntries){
...
void DAQ_LoadGeometry::LoadLAPPDs(){
...
bool DAQ_LoadGeometry::ParseLAPPDDataEntry(std::vector<std::string> SpecLine,
        std::vector<std::string> LAPPDLegendEntries){
  //Parse the line for information needed to fill the detector & channel classes
...
bool DAQ_LoadGeometry::FileExists(std::string name) {
  ifstream myfile(name.c_str());
  return myfile.good();
}


std::string DAQ_LoadGeometry::GetLegendLine(std::string name) {
